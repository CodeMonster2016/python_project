...
BODY_FOOTER = "<div class='footer'>Copyright 2015 @ TeleNav.com</div>"
...
CASE_DETAIL_HEAD              = ("Field Name","Ref Value","Out Value","Condition","Status")
CASE_DETAIL_HEAD_COLUMN_WIDTH = {CASE_DETAIL_HEAD[0]:"22%",
                                 CASE_DETAIL_HEAD[1]:"31%",
                                 CASE_DETAIL_HEAD[2]:"31%",
                                 CASE_DETAIL_HEAD[3]:"8%",
                                 CASE_DETAIL_HEAD[4]:"8%"}
