...
class Report:
    ...
    def generate_report(self):
        ...
        test_suites_result = map(lambda(key):self.__generate_test_suites(key,self.report_path),sorted(os.listdir(self.testoutput_folder)))
    ...
    def __generate_test_suites(self,test_suite,report_path):
        ...
        input_set_result = map(lambda(key):self.__generate_cases_report(test_suite_path,report_path_of_test_suite,key), sorted(os.listdir(test_suite_path)))
    ...
    def __generate_case_detail(self,case_dir,case,report_path):
        ...
        result = decorator.reorder(case, result)
...
if __name__ == '__main__':
    ...
    if not os.path.exists(testoutput):
        ...
        print "*** [Exception] Please make sure testoutput folder is accessible!"
        printUsage()
        sys.exit(255)
